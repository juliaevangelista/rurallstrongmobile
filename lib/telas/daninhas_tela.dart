...
class DaninhasTela extends StatefulWidget {
  const DaninhasTela({Key? key}) : super(key: key);

  @override
  State<DaninhasTela> createState() => _DaninhasTelaState();
}

class _DaninhasTelaState extends State<DaninhasTela> {
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Image.asset(
                      'assets/icon-daninhas-verde.png',
                      fit: BoxFit.contain,
                    ),
                  ),
                  SizedBox(
