...
class PragasTela extends StatefulWidget {
  const PragasTela({Key? key}) : super(key: key);

  @override
  State<PragasTela> createState() => _PragasTelaState();
}

class _PragasTelaState extends State<PragasTela> {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (userId != null) {
                      ...
                      FirebaseFirestore.instance
                          .collection(
                              'users/$userId/dados_monitoramento_pragas')
                          .add(data)
                          .then((value) {
                        _limparCampos();
