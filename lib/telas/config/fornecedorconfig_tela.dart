...
import 'package:rurallstrong/telas/config/lista/fornecedorlista_tela.dart';
import 'package:rurallstrong/telas/telateste.dart';

class FornecedorConfigTela extends StatefulWidget {
  const FornecedorConfigTela({Key? key}) : super(key: key);

  @override
  State<FornecedorConfigTela> createState() => _FornecedorConfigTelaState();
}

class _FornecedorConfigTelaState extends State<FornecedorConfigTela> {
  @override
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => FornecedorListaTela()),
              )
            },
            child:
          Container(
          ...
          ElevatedButton(
            onPressed: () {},
            child: Text('NOVO FORNECEDOR', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18),),
            style: ElevatedButton.styleFrom(
