...
import 'package:rurallstrong/telas/config/lista/veiculolista_tela.dart';
import 'package:rurallstrong/telas/inicio_tela.dart';
import 'package:rurallstrong/telas/telateste.dart';

class VeiculoConfigTela extends StatefulWidget {
  const VeiculoConfigTela({Key? key}) : super(key: key);

  @override
  State<VeiculoConfigTela> createState() => _VeiculoConfigTelaState();
}

class _VeiculoConfigTelaState extends State<VeiculoConfigTela> {
  @override
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => VeiculoListaTela()),
              )
            },
            child:
          Container(
          ...
          ElevatedButton(
            onPressed: () {},
            child: Text('NOVO VEICULO', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18),),
            style: ElevatedButton.styleFrom(
