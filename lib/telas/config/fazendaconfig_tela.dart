...
class FazendaConfigTela extends StatefulWidget {
  const FazendaConfigTela({Key? key}) : super(key: key);

  @override
  State<FazendaConfigTela> createState() => _FazendaConfigTelaState();
}

class _FazendaConfigTelaState extends State<FazendaConfigTela> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ElevatedButton(
            onPressed: () {},
            child: Text('NOVA FAZENDA', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18),),
            style: ElevatedButton.styleFrom(
